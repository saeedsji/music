<template>
    ...
    <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
        ...
        <!-- TOS -->
        <div class="mb-3 pl-6">
            <vee-field type="checkbox" name="tos" value="1" id="tos" class="w-4 h-4 float-left -ml-6 mt-1 rounded" />
    ...
    methods: {
        ...
        async register(values) {
            ...
            try {
                ...
                this.reg_alert_msg = "An unexpected error pccured. Please try again later";
                return;
            }

    ...
    <main>
        ...
        <section class="container mx-auto mt-6" id="comments">
            <div class="bg-white rounded border border-gray-200 relative flex flex-col">
                ...
                <div class="p-6">
                    <div :class="comment_alert_variant" v-if="comment_show_alert"
                    ...
                    <vee-form v-if="userLoggedIn" :validation-schema="schema" @submit="addComment">
                        ...
                        <button :disabled="comment_in_submission" type="submit"
                            class="py-1.5 px-3 rounded text-white bg-green-600 block mt-3">
                            Submit
                        </button>
                    </vee-form>
                    <!-- Sort Comments -->
        ...
        <ul class="container mx-auto">
            <li v-for="comment in sortedComments" :key="comment.docID" class="p-6 bg-gray-50 border border-gray-200">
                <!-- Comment Author -->
                <div class="mb-5">
                    <div class="font-bold">Saeed Jalali</div>

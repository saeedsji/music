...
export default {
  ...
  methods: {
    handleScroll() {
      ...
      const bottemOfWindow = Math.round(scrollTop) + innerHeight === offsetHeight;
    ...
    async getSongs() {
      ...
      if (this.pendingRequets) {
        return;
      }

      this.pendingRequets = true;
